...
TEST(MachineInstrTest, SpliceOperands) {
  ...
  MCInstrDesc MCID = {TargetOpcode::INLINEASM, 0, 0, 0, 0, 0, 0, 0, 0,
  ...
  MachineOperand Ops [] = {
    MachineOperand::CreateImm(42),
    MachineOperand::CreateImm(1024),
    MachineOperand::CreateImm(2048),
    MachineOperand::CreateImm(4096),
  ...
  EXPECT_EQ(MI->getOperand(2).getImm(), MachineOperand::CreateImm(1024).getImm());
  EXPECT_EQ(MI->getOperand(3).getImm(), MachineOperand::CreateImm(2048).getImm());
  EXPECT_EQ(MI->getOperand(4).getImm(), MachineOperand::CreateImm(4096).getImm());
  EXPECT_EQ(MI->getOperand(5).getImm(), MachineOperand::CreateImm(8192).getImm());
