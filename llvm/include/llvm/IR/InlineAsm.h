...
public:
  ...
  //     Bit  30    - If the register is permitted to be spilled. (RegMayBeSpilled)
  //                  Defaults to false "r", may be set for constraints like "rm" (or "g").
  //
  ...
  public:
    ...
    void setRegMayBeSpilled(bool B) {
      // TODO: what about RegDefEarlyClobber?
      assert((isRegDefKind() || isRegUseKind()) && "Must be reg");
